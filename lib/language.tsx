...
const text = {
  ...
  createAccountDesc: { en: 'Use Supabase Auth with email or mobile OTP. This MVP page demonstrates the onboarding sequence before wiring auth.', my: 'Email သို့မဟုတ် ဖုန်း OTP ဖြင့် Supabase Auth ကို အသုံးပြုပါ။ ဒီ MVP စာမျက်နှာသည် auth ချိတ်ဆက်မည့် မတိုင်မီ onboarding အဆင့်များကို ပြထားသည်။' },
